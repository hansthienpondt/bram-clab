...
ip link set address 00:c1:00:dc:02:14 dev bond0
ip addr add 91.216.20.201/26 dev bond0
ip -6 addr add 2001:67c:1cc:2::14/64 dev bond0
...
ip r a 10.0.0.0/8 via 91.216.20.193 dev bond0
